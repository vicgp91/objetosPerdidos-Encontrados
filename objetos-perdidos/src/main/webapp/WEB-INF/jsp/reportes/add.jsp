...
<form:form method="POST" action="${url}" modelAttribute="reportevo"
	...
	<div class="page-header col-lg-12" id="areaTituloPantalla">
		...
		<div class="row form-group">
			<div class="col-lg-9">
				<form:input  type="text" path="reportetittle" placeholder="Titúlo" class="form-control" />
		...
		<div class=" row form-group">
			<div class="col-lg-9">
				<form:textarea type="text" path="descripcion" placeholder="descripción" class="form-control" />
